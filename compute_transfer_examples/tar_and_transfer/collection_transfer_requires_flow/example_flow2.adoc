...
The **flow** is intended to be invoked from the Globus webapp when initating a transfer where the **destination** collection has this flow set as the destination in its `associated_flow_policy`.
