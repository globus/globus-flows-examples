== Example Flow 1
In this first example, the Compute and Transfer **flow** takes a `globus-transfer-transfer#0.10` object from a transfer and determines the source files and destination endpoint from
